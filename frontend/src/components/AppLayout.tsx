        ...
        <header className="flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white px-6 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <button onClick={() => navigate('/login')} className="flex h-9 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50">
                Login
              </button>
            )}
          </div>
